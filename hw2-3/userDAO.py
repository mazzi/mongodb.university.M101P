...
class UserDAO:
    ...
    def validate_login(self, username, password):
        ...
        try:
            ...
            print "This space intentionally left blank. Find " + user['_id']
        except:
            print "Unable to query database for user. Error: %s", sys.exc_info()[0]
    ...
    def add_user(self, username, password, email):
        ...
        try:
            ...
            print "This space intentionally left blank. User inserted " + user['_id']
